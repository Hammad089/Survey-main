...
export default function DataCardsScreen({navigation}) {
    const config = {
        dependencies: {
        ...
        <View style={style.container}>
                ...
                <NativeBaseProvider>
                    <Box flex={1} bg="#fff">
                        ...
                        <Menu w="190" justifyContent='space-between' alignItems='center' trigger={triggerProps => {
                            ...
                            <Menu.Item onPress={()=>navigation.navigate('Home')}>Dashboard</Menu.Item>
                            <Menu.Item onPress={()=> navigation.navigate('Survey')}>Survey</Menu.Item>
                            <Menu.Item onPress={()=>navigation.navigate('TableData')}>Draft Data</Menu.Item>
            ...
            <NativeBaseProvider>
                ...
                <NativeBaseProvider config={config}>
                    <TouchableOpacity onPress={() => navigation.navigate('PublishTableData')}>
                        <View style={{marginBottom:20}}>
                            ...
                            >
                                <Text style={{ textAlign: 'center', color: 'white', fontSize: 25 }}>Published
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('TableData')}>
                        <View>
                            ...
                            >
                                <Text style={{ textAlign: 'center', color: 'white', fontSize: 25 }}>Local
                                    <FeatherIcon name='chevron-right' size={20} />
                                </Text>
                            </Box>
                        </View>
