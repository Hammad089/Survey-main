  ...
  <>
      ...
      <NativeBaseProvider>
       ...
       <Menu trigger={triggerProps => {
        ...
        <View>
          <Text style={{fontSize:18, color:'white', fontWeight:'700'}}>Test-2</Text>
        </View>
     ...
     <Menu  trigger={triggerProps => {
      ...
      {/* <View style={styles.container}>
        <Text style={{ textAlign: 'center', marginTop: 5, color: 'white', fontSize: 15, fontWeight:'700' }}>Test-2</Text>
      </View> */}
