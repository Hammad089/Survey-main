...
export default function InProgress({ AssignmentData, navigation,Itemid }) {
  const ongoingAssignment = AssignmentData.filter((assignment) => assignment.status === 'in-progress');
  return (
    <>
